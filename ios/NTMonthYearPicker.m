...
- (UIView *)pickerView:(UIPickerView *)pickerView
    ...
    [label setTextColor:(outOfBounds ? [UIColor grayColor] : self.textColor )];
    return label;
}
...
- (void)setTextColorProp:(NSString *)hexColor
{
    ...
    if(@available(iOS 13, *)) {
        ...
        // white text -> set dark mode
            ...
            _pickerView.overrideUserInterfaceStyle = UIUserInterfaceStyleDark;
        }
        // other colors -> remove "Today" string since it cannot be colored from iOS 13.
            ...
            [_pickerView setTextColor: UIColorFromRGB(intColor)];
        }
    }
